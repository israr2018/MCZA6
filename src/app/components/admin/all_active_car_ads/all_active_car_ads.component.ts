...
export class AllActiveCarAdsComponent implements OnInit {

    pageTitle: string = "All Active Car Ads ";
    allCarAds: any[] = [];
    allCarMakes: any[] = [];
    allCarModels: any[] = [];
    model: any = {};
    ...
    countAllCarAds(): void {
        this._carAdService.getCarAds().subscribe((result) => {
            ...
            console.log("all_active_car_Ads count "+result.length);
        },
    ...
    countAllInActiveCarAds(): void {
        ...
        this._carAdService.getActiveCarAds(false).subscribe((result => {
            ...
            console.log("in_active_car_ads :"+ this._adminComponent.in_active_car_ads_count);
